...
public class FiscalPrinterExporter extends GenericPOHandler {
	public void create(Properties ctx, TransformerHandler document) throws SAXException {
		...
		List<MADDeviceType> deviceTypeList = new Query(ctx, I_AD_DeviceType.Table_Name, 
				"EXISTS(SELECT 1 FROM AD_FP_Document WHERE AD_DeviceType_ID = AD_DeviceType.AD_DeviceType_ID)", getTrxName(ctx))
